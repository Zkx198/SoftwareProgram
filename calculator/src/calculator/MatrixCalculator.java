...
public class MatrixCalculator extends WindowAdapter {
	...
	Font fontOfNumber = new Font("华文行楷", Font.PLAIN, 10);
	...
	public void Matrix() {
		...
		input_Panel= new Panel(new GridLayout(1,2,1,4));
		...
		adjoint_Button.setForeground(Color.RED);
		rank_Button= new Button("Ar");
		rank_Button.setForeground(Color.RED);
		trace_Button= new Button("tr(A)");
		trace_Button.setForeground(Color.RED);
		plus_Button= new Button("+");
		plus_Button.setForeground(Color.RED);
		mins_Button= new Button("-");
		mins_Button.setForeground(Color.RED);
		multiply_Button= new Button("*");
		multiply_Button.setForeground(Color.RED);
