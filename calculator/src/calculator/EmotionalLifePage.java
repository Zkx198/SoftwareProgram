...
public class EmotionalLifePage extends WindowAdapter{
	...
	public void emotional() {
		...
		in0_Panel.setPreferredSize(new Dimension(260, 150));
		in1_Panel = new Panel(new FlowLayout());
		in1_Panel.setPreferredSize(new Dimension(260, 150));
		in4_Panel = new Panel(new FlowLayout());
		in4_Panel.setPreferredSize(new Dimension(260, 100));
		in5_Panel = new Panel(new FlowLayout());
		input_Panel.add(in0_Panel);
		
		blank1_Label = new JLabel("                            \r\n");
		blank1_Label.setPreferredSize(new Dimension(260, 70));
		...
		blank2_Label.setPreferredSize(new Dimension(260, 50));
		...
		result1_Panel.setPreferredSize(new Dimension(500, 210));
		...
		result2_Panel.add(lblNewLabel_5);
		
		lblNewLabel_6 = new JLabel("                                                                     ");
		result2_Panel.add(lblNewLabel_6);
