...
public class BasicCalculator extends WindowAdapter implements ActionListener {
	...
	public void cal() {
		...
		m_Panel = new Panel(new GridLayout(5, 1, 10, 10));
		...
		m_Panel.setPreferredSize(new Dimension(80, 280));
		...
		display_Textfield.setForeground(new Color(255, 255, 255));
		display_Textfield.setBackground(new Color(0, 0, 0));
		...
		div_Button.setBackground(new Color(0, 0, 102));
		sqrt_Button = new Button("sqrt");
		sqrt_Button.setBackground(Color.DARK_GRAY);
		sqrt_Button.setForeground(Color.WHITE);
		multi_Button = new Button("*");
		multi_Button.setBackground(new Color(0, 0, 102));
		minus_Button = new Button("-");
		minus_Button.setBackground(new Color(0, 0, 102));
		...
		reciprocal_Button.setBackground(Color.DARK_GRAY);
		reciprocal_Button.setForeground(Color.WHITE);
		...
		square_Button.setBackground(Color.DARK_GRAY);
		square_Button.setForeground(Color.WHITE);
		sin_Button = new Button("sin");
		sin_Button.setBackground(Color.DARK_GRAY);
		sin_Button.setForeground(Color.WHITE);
		cos_Button = new Button("cos");
		cos_Button.setBackground(Color.DARK_GRAY);
		cos_Button.setForeground(Color.WHITE);
		factorial_Button = new Button("n!");
		factorial_Button.setForeground(Color.WHITE);
		factorial_Button.setBackground(Color.DARK_GRAY);
		tan_Button = new Button("tan");
		tan_Button.setBackground(Color.DARK_GRAY);
		tan_Button.setForeground(Color.WHITE);
		exp_Button = new Button("exp");
		exp_Button.setBackground(Color.DARK_GRAY);
		exp_Button.setForeground(Color.WHITE);
		ln_Button = new Button("ln");
		ln_Button.setBackground(Color.DARK_GRAY);
		ln_Button.setForeground(Color.WHITE);
		combi_Button = new Button("c");
		combi_Button.setBackground(Color.DARK_GRAY);
		combi_Button.setForeground(Color.WHITE);
		div_Button.setForeground(new Color(255, 255, 255));
		multi_Button.setForeground(new Color(255, 255, 255));
		minus_Button.setForeground(new Color(255, 255, 255));
		plus_Button.setForeground(new Color(255, 255, 255));
		equal_Button.setForeground(new Color(255, 255, 255));
		dot_Button.setForeground(new Color(255, 255, 255));
		negative_Button.setForeground(new Color(255, 255, 255));
	...
	//	key_Panel.add(percent_Button);
		...
		m_Textfield.setBackground(new Color(169, 169, 169));
		m_Textfield.setFont(new Font("Times New Roman", Font.ITALIC, 20));
		MC_Button = new Button("MC");
		MC_Button.setBackground(new Color(0, 51, 102));
		MC_Button.setForeground(new Color(255, 255, 255));
		MR_Button = new Button("MR");
		MR_Button.setBackground(new Color(0, 51, 102));
		MR_Button.setForeground(new Color(255, 255, 255));
		MS_Button = new Button("MS");
		MS_Button.setBackground(new Color(0, 51, 102));
		MS_Button.setForeground(new Color(255, 255, 255));
		Mplus_Button = new Button("M+");
		Mplus_Button.setBackground(new Color(0, 51, 102));
		Mplus_Button.setForeground(new Color(255, 255, 255));
