...
public class BasicCalculator extends WindowAdapter implements ActionListener {
	...
	public void cal() {
		...
		number1_Button.setForeground(new Color(0, 0, 0));
		number2_Button = new Button("2");
		number2_Button.setForeground(new Color(0, 0, 0));
		number3_Button = new Button("3");
		number3_Button.setForeground(new Color(0, 0, 0));
		number4_Button = new Button("4");
		number4_Button.setForeground(new Color(0, 0, 0));
		number5_Button = new Button("5");
		number5_Button.setForeground(new Color(0, 0, 0));
		number6_Button = new Button("6");
		number6_Button.setForeground(new Color(0, 0, 0));
		number7_Button = new Button("7");
		number7_Button.setForeground(new Color(0, 0, 0));
		number8_Button = new Button("8");
		number8_Button.setForeground(new Color(0, 0, 0));
		number9_Button = new Button("9");
		number9_Button.setForeground(new Color(0, 0, 0));
		number0_Button = new Button("0");
		number0_Button.setForeground(new Color(0, 0, 0));
		...
		reciprocal_Button.setForeground(new Color(0, 0, 0));
		equal_Button = new Button("=");
		dot_Button = new Button(".");
		negative_Button = new Button("+/-");
		square_Button = new Button("^2");
		square_Button.setForeground(new Color(0, 0, 0));
		sin_Button = new Button("sin");
		sin_Button.setForeground(new Color(0, 0, 0));
		cos_Button = new Button("cos");
		cos_Button.setForeground(new Color(0, 0, 0));
		factorial_Button = new Button("n!");
		tan_Button = new Button("tan");
		tan_Button.setForeground(new Color(0, 0, 0));
		exp_Button = new Button("exp");
		exp_Button.setForeground(new Color(0, 0, 0));
		ln_Button = new Button("ln");
		ln_Button.setForeground(new Color(0, 0, 0));
		combi_Button = new Button("c");
		combi_Button.setForeground(new Color(0, 0, 0));
	...
	//	key_Panel.add(percent_Button);
		...
		MC_Button.setForeground(new Color(0, 0, 0));
		MR_Button = new Button("MR");
		MR_Button.setForeground(new Color(0, 0, 0));
		MS_Button = new Button("MS");
		MS_Button.setForeground(new Color(0, 0, 0));
		Mplus_Button = new Button("M+");
		Mplus_Button.setForeground(new Color(0, 0, 0));
