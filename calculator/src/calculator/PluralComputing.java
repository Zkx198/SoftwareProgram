...
public class PluralComputing extends WindowAdapter implements ActionListener {
	...
	public void plural() {
		...
		equal_Button.setBackground(new Color(0, 51, 102));
		dot_Button = new Button(".");
		dot_Button.setBackground(new Color(0, 51, 102));
		negative_Button = new Button("+/-");
		negative_Button.setBackground(new Color(0, 51, 102));
		i_Button = new Button("i");
		i_Button.setBackground(new Color(0, 51, 102));
		...
		Del_Button.setBackground(Color.LIGHT_GRAY);
		C_Button = new Button("C");
		C_Button.setForeground(Color.BLACK);
		C_Button.setBackground(Color.LIGHT_GRAY);
